...
*The RAG loop: embed the query, retrieve the nearest chunks from the vector DB, pass them as context to the LLM, generate a grounded response. Piramid sits in the retrieval step.*
