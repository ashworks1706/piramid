...
This is where my story really begins. I got into AI through an unusual path — I started with agents, then dove deep into RAG while building [SparkyAI](https://github.com/ashworks1706/SparkyAI) (where I seriously went down the rabbit hole of reranking mechanisms and [advanced RAG variations](https://somwrks.notion.site/)), then worked backwards into LLMs and transformer architectures through my [Advanced Deep Learning class](https://github.com/ashworks1706/LLM-from-scratch) and self-study. Most people go the other way around. But by the time I was building RAG systems for hackathons, I was already a heavy [Qdrant](https://qdrant.tech/) user — it was my go-to vector database for everything. I'd read their blogs, understood the config deeply, and used it across every project I shipped.
...
I started thinking about vector databases as a kind of decoupled brain for LLMs — the same way transformers use cosine-based attention and positional embeddings internally, a vector database does something similar but externally, as a separate retrieval memory. That mental model helped me understand both systems more deeply.
