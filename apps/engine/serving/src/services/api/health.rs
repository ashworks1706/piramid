...
pub struct CollectionHealth {
    ...
    /// Whether the collection passed integrity checks. Always true.
    pub integrity_ok: bool,
    /// Error message for an unhealthy collection. Always absent.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct ReadyzResponse {
    /// True when every collection reports integrity_ok.
    pub ok: bool,
    /// Version of the running binary.
    pub version: String,
